...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-[#DC143C]/10 shadow-2xl z-50 safe-area-inset-bottom">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute -top-0.5 -right-0.5 w-1.5 h-1.5 bg-[#DC143C] rounded-full"
                ...
                {isActive && (
                  <motion.div
                    layoutId="activeBar"
                    className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-8 h-0.5 bg-[#DC143C] rounded-full"
                    transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}
                  />
                )}
              </button>
