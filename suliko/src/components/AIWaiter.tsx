...
const aiResponses = [
  'Добро пожаловать в Тбилиси! Чем могу помочь?',
  'Наши фирменные блюда - это Хинкали и Хачапури по-аджарски. Рекомендую попробовать!',
  'У нас есть отличные вегетарианские опции: Пхали, Лобио, Бадриджани. Хотите узнать подробнее?',
  'Конечно! Сейчас позову официанта к вашему столику.',
  'Отличный выбор! Это блюдо готовится около 15-20 минут.',
  'Рекомендую попробовать грузинское вино Саперави - оно прекрасно дополнит ваш выбор!',
];
    ...
    <div className="max-w-4xl mx-auto px-3 py-4 h-[calc(100vh-140px)] flex flex-col">
      ...
      >
        <div className="flex items-center gap-2.5 mb-1.5">
          ...
          <h2 className="text-[#DC143C]">AI Официант</h2>
        </div>
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 px-3 py-2.5 bg-white border-2 border-[#DC143C]/20 rounded-xl focus:outline-none focus:border-[#DC143C] transition-colors text-sm"
        />
        <motion.button
          whileTap={{ scale: 0.95 }}
          onClick={handleSend}
          className="bg-gradient-to-r from-[#DC143C] to-[#8B0000] text-white p-2.5 rounded-xl shadow-lg"
        >
